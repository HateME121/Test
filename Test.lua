...
local function getRAP(Type, Item)
    if RAPCmds and RAPCmds.Get then
        ...
        warn("[WARN] RAPCmds.Get not available, returning 0 for item RAP")
        return 0
    end
end
...
-- Categories to collect (excluding Booth & Hoverboard)
...
print("[INFO] Total items collected:", #sortedItems)

-- Send a single item stack, cycle users if mailbox full
...
-- Claim mailboxes and empty boxes
